...
echo "  - To use the app again, run: python sagemaker_deploy.py --skip-ecr --image-uri YOUR_AWS_ACCOUNT_ID.dkr.ecr.us-east-2.amazonaws.com/fibroblast-detection:latest"
echo ""
...
echo "  python sagemaker_deploy.py --skip-ecr --image-uri YOUR_AWS_ACCOUNT_ID.dkr.ecr.us-east-2.amazonaws.com/fibroblast-detection:latest"
echo ""
